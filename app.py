...
def fetch_locations():
    data = {
        "Lieu": ["Boulder, Colorado","Voiron, France", "Denver, Colorado, USA", "Drôme, France", "Font-Romeu, France", "Divonne-les-Bains, France", "Lyon, France", "Tanzanie", "Afrique du Sud", "Mâcon, France", "Courchevel, France","Burkina Faso"],
        "Latitude": [40.0151,45.367, 39.7392, 44.7631, 42.5037, 46.356, 45.764, -6.369, -30.5595, 46.306, 45.414,12.32553],
        "Longitude": [-105.25663,5.5788, -104.9903, 5.424, 1.982, 6.139, 4.835, 34.8888, 22.9375, 4.830, 6.631,1.71458]
    }
...
def create_map(data):
    m = folium.Map(location=[48.41618, -24.22010], zoom_start=2.5)  # Centré sur la France par défaut
    for _, row in data.iterrows():
